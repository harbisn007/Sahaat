          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
              ...
              <Text style={{
                ...
                أقر وأتعهد عند استخدامي لتطبيق / منصة ساحات المحاورة بالالتزام التام بقواعد الذوق العام وتجنب أي طرح يسبب الفرقة او يسيء للنظام العام او القيم الدينية او يسيء لأي مكون من مكونات المحتمع وان لا اقوم بأي فعل من افعال الجرائم المعلوماتية ، وأتحمل المسؤولية الكاملة عن كل ما يصدر من حسابي من رسائل أو وسائط، وأقر بأن إدارة المنصة لها الحق في تزويد الجهات المعنية ببياناتي عند حدوث أي مخالفة نظامية.
              </Text>
            </View>
