...
const SHEELOHA_CONFIG = {
  ...
  voiceSettings: [
    { delay: 0,   volume: 0.90 },   // صوت 1: الأول
    { delay: 30,  volume: 0.85 },   // صوت 2: بعد 30ms
    { delay: 60,  volume: 0.80 },   // صوت 3: بعد 60ms
    { delay: 90,  volume: 0.85 },   // صوت 4: بعد 90ms
    { delay: 120, volume: 0.80 },   // صوت 5: بعد 120ms
  ],
